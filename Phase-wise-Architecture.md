...
## Addendum — Golden Dataset Links & References
...
Every URL and file path above was pulled directly from the real data (`phase1/data/citation_index.json`, `phase1/data/pois.json`) and verified to exist, not reconstructed from memory.
